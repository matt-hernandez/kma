...
import { useQueryRequestedPartnerTasks } from '../../../apollo-client/hooks';
...
const Tasks: React.FunctionComponent<RouteComponentProps> = ({
    history,
    location,
    match,
  }) => {
  const { loading, error, data: requestedPartnerTasks } = useQueryRequestedPartnerTasks();
  return (
    <>
      <TabsContainer>
...
export default addPageData(withRouter(Tasks), { slug, title });
